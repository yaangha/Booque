    ...
    function updateCommentList(data){
        ...
        for(let r of data){
            ...
            str += '<div class="my-2">' 
                ...
                + '<div> 좋아요 <span>  </span>'
                + '<div class="likes">'
                + '<img id="likeWhite" alt="" src=" https://cdn-icons-png.flaticon.com/512/7476/7476962.png ">'
                + '<img id="likeRed" alt="" src=" https://cdn-icons-png.flaticon.com/512/833/833472.png ">'
                + '</div>'
                + '<span>  </span>'
                + r.likes+'</div>'
                + '<div class="card-body">'
